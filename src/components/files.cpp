...
auto liboai::Files::create_async(
    const std::filesystem::path& file,
    const std::string& purpose
...
auto liboai::Files::remove_async(const std::string& file_id) const& noexcept(false)
...
auto liboai::Files::retrieve_async(const std::string& file_id) const& noexcept(false)
    -> liboai::FutureResponse {
    return std::async(std::launch::async, &liboai::Files::retrieve, this, file_id);
}

auto liboai::Files::download(
...
auto liboai::Files::download_async(
    const std::string& file_id,
    const std::string& save_to
