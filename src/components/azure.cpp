...
auto liboai::Azure::create_completion(
...
auto liboai::Azure::create_completion_async(
    const std::string& resource_name,
    const std::string& deployment_id,
    const std::string& api_version,
    std::optional<std::string> prompt,
    ...
    return std::async(
        std::launch::async,
        &liboai::Azure::create_completion,
        this,
        resource_name,
        deployment_id,
        api_version,
...
auto liboai::Azure::create_embedding(
    const std::string& resource_name,
    const std::string& deployment_id,
    const std::string& api_version,
...
auto liboai::Azure::create_embedding_async(
    const std::string& resource_name,
    const std::string& deployment_id,
    const std::string& api_version,
    const std::string& input,
...
auto liboai::Azure::create_chat_completion(
    const std::string& resource_name,
    const std::string& deployment_id,
    const std::string& api_version,
...
auto liboai::Azure::create_chat_completion_async(
    const std::string& resource_name,
    const std::string& deployment_id,
    const std::string& api_version,
    Conversation& conversation,
    ...
    return std::async(
        std::launch::async,
        &liboai::Azure::create_chat_completion,
        this,
        resource_name,
        deployment_id,
        api_version,
...
auto liboai::Azure::request_image_generation(
    const std::string& resource_name,
    const std::string& api_version,
...
auto liboai::Azure::request_image_generation_async(
    const std::string& resource_name,
    const std::string& api_version,
    const std::string& prompt,
    std::optional<uint8_t> n,
    ...
    return std::async(
        std::launch::async,
        &liboai::Azure::request_image_generation,
        this,
        resource_name,
        api_version,
        prompt,
...
auto liboai::Azure::get_generated_image(
    const std::string& resource_name,
    const std::string& api_version,
...
auto liboai::Azure::get_generated_image_async(
    const std::string& resource_name,
    const std::string& api_version,
    const std::string& operation_id
) const& noexcept(false) -> liboai::FutureResponse {
    return std::async(
        std::launch::async,
        &liboai::Azure::get_generated_image,
        this,
        resource_name,
        api_version,
        operation_id
...
auto liboai::Azure::delete_generated_image(
    const std::string& resource_name,
    const std::string& api_version,
    const std::string& operation_id
) const& noexcept(false) -> liboai::Response {
...
auto liboai::Azure::delete_generated_image_async(
    const std::string& resource_name,
    const std::string& api_version,
    const std::string& operation_id
) const& noexcept(false) -> liboai::FutureResponse {
    return std::async(
        std::launch::async,
        &liboai::Azure::delete_generated_image,
        this,
        resource_name,
        api_version,
        operation_id
