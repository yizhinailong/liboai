...
namespace liboai {
    ...
    public:
        ...
        /*
           ...
           more creative completions, while lower values will result in more repetitive completions.
           ...
           will result in more creative completions, while higher values will result in more
           repetitive completions.
            @param n                  The number of completions to generate.
            @param stream             Stream partial progress back to the client. A callback
           function that is called each time new data is received from the API. If no callback is
           supplied, this parameter is disabled and the API will wait until the completion is
           finished before returning the response.
           ...
           "best" one. When used with n, best_of controls the number of candidate completions and n
           specifies how many to return � best_of must be greater than n

                                        Because this parameter generates many completions, it can
           quickly consume your token quota. Use carefully and ensure that you have reasonable
