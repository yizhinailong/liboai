    ...
    */
    ...
    public:
        ...
        */
        ...
        /*
				@brief Returns whether the conversation has functions or not. this function
    ...
    private:
         ...
         * @returns vector of string that contains the split data that will contains the last
         * termination string(data: "DONE").
			*/
    ...
    public:
        ...
        /*
            ...
            @param max_tokens        The maximum number of tokens allowed for the generated answer.
                                     ...
                                     (4096 - prompt tokens).
            @param presence_penalty  Number between -2.0 and 2.0. Positive values penalize new
           tokens based on whether they appear in the text so far, increasing the model's likelihood
           to talk about new topics.
            @param frequency_penalty Number between -2.0 and 2.0. Positive values penalize new
