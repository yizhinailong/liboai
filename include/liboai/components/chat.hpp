...
/**
 * @file chat.hpp
 * @brief Chat component header file
 *
 * This class contains all the methods for the Chat component of the OpenAI API.
 * This class provides access to 'Chat' endpoints on the OpenAI API and should be
 * accessed via the liboai.h header file through an instantiated liboai::OpenAI
